...
get_filename_component(OpenCV_INSTALL_PATH "${CMAKE_SOURCE_DIR}/sources/3rdparty/opencv" REALPATH)
...
set(OpenCV_LIB_COMPONENTS opencv_calib3d;opencv_core;opencv_dnn;opencv_features2d;opencv_flann;opencv_gapi;opencv_highgui;opencv_imgcodecs;opencv_imgproc;opencv_ml;opencv_objdetect;opencv_photo;opencv_stitching;opencv_video;opencv_videoio;opencv_aruco)
set(__OpenCV_INCLUDE_DIRS "${OpenCV_INSTALL_PATH}/modules")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/calib3d/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/core/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/dnn/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/features2d/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/flann/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/gapi/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/highgui/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/imgcodecs/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/imgproc/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/ml/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/objdetect/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/photo/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/stitching/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/video/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/videoio/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/world/include")
list(APPEND OpenCV_INCLUDE_DIRS "${__OpenCV_INCLUDE_DIRS}/aruco/include")
list(APPEND OpenCV_INCLUDE_DIRS "${OpenCV_INSTALL_PATH}/builds/${CMAKE_BUILD_TYPE}")

set(OpenCV_LIB_PATH "${OpenCV_INSTALL_PATH}/builds/${CMAKE_BUILD_TYPE}/lib")
set(OpenCV_DLL_PATH "${OpenCV_INSTALL_PATH}/builds/${CMAKE_BUILD_TYPE}/bin")
set(POSTFIX ${OpenCV_VERSION_MAJOR}${OpenCV_VERSION_MINOR}${OpenCV_VERSION_PATCH})
string(TOUPPER ${CMAKE_BUILD_TYPE} build_type)
if(${build_type} STREQUAL "DEBUG")
    set(POSTFIX "${POSTFIX}d")
endif()
foreach(cv_lib ${OpenCV_LIB_COMPONENTS})
    list(APPEND OpenCV_LIBRARIES "${OpenCV_LIB_PATH}/${cv_lib}${POSTFIX}.lib")
    list(APPEND OpenCV_DLL_FILES "${OpenCV_DLL_PATH}/${cv_lib}${POSTFIX}.dll")
endforeach()

set(OpenCV_BIN_PATH "${OpenCV_INSTALL_PATH}/builds/${CMAKE_BUILD_TYPE}/bin")

if(NOT TARGET opencv_core)
  include(${OpenCV_INSTALL_PATH}/builds/${CMAKE_BUILD_TYPE}/OpenCVModules${OpenCV_MODULES_SUFFIX}.cmake)
endif()
