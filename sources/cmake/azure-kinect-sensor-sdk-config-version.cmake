...
set(PACKAGE_FIND_VERSION "${CMAKE_SOURCE_DIR}/sources/3rdparty/Azure-Kinect-Sensor-SDK/src")

set(versionfile "NOTFOUND")
find_file(versionfile "version.txt"
      PATHS "${PACKAGE_FIND_VERSION}"
      NO_DEFAULT_PATH)
...
message(STATUS "Azure Kinect SDK is found file the version.txt.")
